...
# Plot the histogram for Population 4 with a single color and no legend
...
ggsave(filename = paste0("histogram_control_pop25.png"), plot = plot4, bg = "white", width = 3.4, height = 3.4, dpi = 300)
