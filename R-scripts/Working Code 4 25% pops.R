create_test_mixed_population <- function(total_population_size = 11860,
  ...
  if (num_euploid + num_aneuploid_100 + num_aneuploid_95 + num_aneuploid_90 + num_aneuploid_85 +
      ...
      num_aneuploid_30 + num_aneuploid_25 + num_aneuploid_20 + num_aneuploid_15 + num_aneuploid_10 + num_aneuploid_05 > total_population_size) {
  ...
  data.frame(
    ...
    prop.aneuploid = c(
      ...
      rep(NA, total_population_size - (num_euploid + num_aneuploid_100 + num_aneuploid_95 + num_aneuploid_90 + num_aneuploid_85 +
                                         num_aneuploid_80 + num_aneuploid_75 + num_aneuploid_70 + num_aneuploid_65 + num_aneuploid_60 +
                                         num_aneuploid_55 + num_aneuploid_50 + num_aneuploid_45 + num_aneuploid_40 + num_aneuploid_35 +
                                         num_aneuploid_30 + num_aneuploid_25 + num_aneuploid_20 + num_aneuploid_15 + num_aneuploid_10 + num_aneuploid_05))  # Fill in with NA if any remaining slots
    ),
...
# Load the CSV file
populations_df <- read.csv("Euploid 0-25 and fixed aneuploid pop.csv")
...
write.csv(summary_results, "summary_results_euploid0-25fixedaneuploids.csv", row.names = FALSE)
